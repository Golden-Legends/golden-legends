...
export class ObjectGame {
  ...
  private collectObject(): void {
    ...
    if (taille === this.totalObjects) {
      ...
      document
        .getElementById("recup-allObject-dialog")!
      ...
      document
        .getElementById("recup-object-dialog")!
        .classList.remove("hidden");
      setTimeout(() => {
          ...
          new ExecuteCodeAction(
            ...
            () => {
              ...
              switch (i) {
                case 0:
                  document
                    .getElementById("haie-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 1:
                  document
                    .getElementById("gant-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 2:
                  document
                    .getElementById("raquette-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 3:
                  document
                    .getElementById("ballon-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 4:
                  document
                    .getElementById("skate-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 5:
                  document
                    .getElementById("arc-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 6:
                  document
                    .getElementById("chaussure-object-dialog")!
                    .classList.remove("hidden");
                  break;
                case 7:
                  document
                    .getElementById("velo-object-dialog")!
                    .classList.remove("hidden");
                  break;
                default:
                  break;
  ...
  initCube(x: number, y: number, z: number, pos: number, name: string): void {
    ...
    this.cube[pos].position = new Vector3(x, y, z); // Changez la position du cube selon vos besoins
  ...
  public modifierValeurFound(nomObjet: string) {
    ...
    // (JSON.parse(localStorage.getItem('objects')!)); // Pour vérification
    storeObjects.commit(
      "setObjects",
