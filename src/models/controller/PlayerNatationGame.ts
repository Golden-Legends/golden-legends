...
export class PlayerNatationGame {
    ...
    if (!this.isEndGame) {
      if (!this.isSequentialAnimation) {
        if (!this.isTextPlongeonShow) {
          ...
          document
            .getElementById("natationGame-text-plongeon")!
  ...
  public runPlongeonAnim() {
    this.plongeonAnim.start(
      false,
      1.0,
      this.plongeonAnim.from,
