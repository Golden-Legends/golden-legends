...
const objetRaquetteText = "Récupére la Raquette de tennis en appuyant sur Espace";
...
const objetChaussureText = "Récupére les Chaussures de course en appuyant sur Espace";
