...
import jeuSaut from "@/assets/jeuSaut.png";
import objets from "@/assets/objets.png";
      ...
      <div class="rounded-xl backdrop-brightness-75 px-4 py-4 w-3/4">
        <CarouselContent v-if="carousel === 0">
          <div>
            ...
            <span
              >Arrivez au bout de ce jeu d'habilité et d'équilibre pour débloquer 2 nouveaux personnages.</span
            >
            <img
              :src="jeuSaut"
              alt="jeuSaut"
        ...
        <CarouselContent v-if="carousel === 1">
          <div>
            <Title text="Débloquer de nouveaux personnages !"></Title>
            <span
              >Ramassez tous les objets olympiques (il y en a 8) présents dans le lobby pour débloquer 2 nouveaux personnages.
              Une fumée rouge sort de ces objets pour vous aider.</span
            >
            <img
              :src="objets"
              alt="objets"
